...
<div className="col-lg-4 team_col">
            <div className="team_item">
              ...
              <Link to={`/about/trainers/${trainer._id}`}>{<img src={imageHelper.getImage(trainer.name) !== undefined ? imageHelper.getImage(trainer.name) : trainer.imageUrl} alt={trainer.name} /> }</Link>
              </div>
              <div className="team_panel d-flex flex-column align-items-center justify-content-center text-center">
                ...
                <div className="team_courses">Courses: {trainer.courses !== undefined
                ? trainer.courses.join(", ")
                : ""}</div>
              </div>
            </div>
    </div>
